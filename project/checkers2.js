...
function createTable(){
 ...
 blackPieces = n*3/2;
 whitePieces = n*3/2;
 playerstats.c1.numMoves = 0;
  playerstats.c2.numMoves = 0;
...
function updateMoves(){
  ...
  if(td1!=null){
  td1.innerText =playerstats.c1.numMoves;
  }
  if(td2!=null){
  td2.innerText =playerstats.c2.numMoves;
  }
}
